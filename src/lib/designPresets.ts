...
const NESTED_OVERRIDE_KEYS: Record<string, Set<string>> = {
  ...
  page: new Set(["background", "marginScale", "pageWidth", "bindingDirection", "writingMode", "readerMode", "paragraphSpacing"]),
