...
const points: Array<{
  ...
  },
  {
    number: "02",
    title: "個人でも使える安心の価格",
    body: "出版プランは1冊分980円から。運用スタンダードは月額980円・1冊分、運用プラスは月額1,980円・10冊分で、気軽にWebブックを公開できます。",
  ...
  },
  {
    ...
    body: "出版プランも公開後も継続編集でき、運用スタンダードは1冊、運用プラスは10冊を継続運用できます。公開して終わりではなく、作品を育てていけます。",
