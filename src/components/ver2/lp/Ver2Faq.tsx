    ...
    <section className={`${styles.section} ${styles.faqSection}`} id="faq">
      <div className={styles.container}>
        ...
        <div className={styles.faqGrid}>
          ...
          <details className={styles.faqItem}><summary>無料でどこまで使えますか？</summary><p>無料プランでは作成とプレビューを試せます。1冊分を公開する場合は出版プランまたは運用スタンダード、10冊分を継続運用する場合は運用プラスをご利用ください。</p></details>
        </div>
      </div>
    </section>
  );
