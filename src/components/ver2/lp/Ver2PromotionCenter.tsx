      ...
      <div className={styles.container}>
        ...
        <div className={styles.promoGrid}>
          <article className={`${styles.promo} ${styles.videoCard}`}>
            ...
            <a className={`${styles.promoCta} ${styles.videoCta}`} href="#video">動画を作る →</a>
          </article>
          <article className={`${styles.promo} ${styles.xCard}`}>
            ...
            <a className={`${styles.promoCta} ${styles.xCta}`} href="#xshare">Xで共有する →</a>
          </article>
          <article className={`${styles.promo} ${styles.noteCard}`}>
            ...
            <a className={`${styles.promoCta} ${styles.noteCta}`} href="#note">note記事を作る →</a>
          </article>
          <article className={`${styles.promo} ${styles.portfolioCard}`}>
            ...
            <a className={`${styles.promoCta} ${styles.portfolioCta}`} href="#author">作者ページを見る →</a>
          </article>
        </div>
      </div>
    </section>
