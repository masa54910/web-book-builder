  ...
  return (
    <footer className={styles.footer} id="help">
      <div className={`${styles.container} ${styles.footerRow}`}>
        ...
        <div className={styles.footerLinks}><Link href="/how-to">作り方</Link><Link href={SAMPLE_BOOK_ROUTE}>サンプル</Link><Link href="/pricing">料金プラン</Link><Link href="/promote">作品を広める</Link><Link href="/faq">よくある質問</Link><Link href="/terms">利用規約</Link><Link href="/privacy">プライバシー</Link><Link href="/commerce">特商法表記</Link><Link href="/guidelines">投稿ガイドライン</Link><Link href="/refund">返金方針</Link><Link href="/contact">お問い合わせ</Link></div>
