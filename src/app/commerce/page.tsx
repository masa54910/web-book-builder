...
export default function CommercePage() {
  return (
    <LegalPageShell kicker="Commerce" title="特定商取引法に基づく表記" titleClassName="legal-title-commercial">
      ...
      <p>WebBookMakerでは、1冊分の公開枠を使う出版プラン・運用スタンダードと、10冊分の公開枠を使う運用プラスを提供しています。購入前に料金ページとCheckout開始前の確認画面で条件を表示します。</p>
      ...
      <dl className="legal-definition-list">
        ...
        <div><dt>販売価格</dt><dd>出版プランは税込¥980 / 1冊分（買い切り）、運用スタンダードは税込¥980 / 月・1冊分、運用プラスは税込¥1,980 / 月・10冊分です。購入前の料金ページおよびCheckout開始前画面にも表示します。</dd></div>
        ...
        <div><dt>サービス提供時期</dt><dd>決済確認後、出版プランは対象作品の公開機能を、運用スタンダードは1冊分、運用プラスは10冊分の公開・運用機能を契約期間中利用できます。</dd></div>
